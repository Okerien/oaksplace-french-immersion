...
export const metadata: Metadata = {
  title: `You're Registered! | French Immersion | ${site.name}`,
  robots: { index: false, follow: false },
};

export default function FrenchImmersionThankYouPage() {
  return (
    <>
      {/*
        Ad conversion tracking: fire your Meta Pixel / Google Ads / TikTok
        conversion event here once you have the pixel IDs, e.g.:
        <Script id="fi-conversion" strategy="afterInteractive">
      ...
      <Section tone="cream" className="pt-16">
        <Reveal className="mx-auto max-w-xl text-center">
          ...
          <h1 className="mt-3 text-4xl font-medium text-dark-green md:text-5xl">
            Merci! Your French Immersion registration is in.
          </h1>
          <p className="mt-5 leading-relaxed text-muted">
            Our team will personally reach out within 1–2 business days to confirm your
            child&rsquo;s spot, walk you through fees and payment options, and answer any
            questions you have — no pressure, no obligation.
          </p>

          <div className="mt-8 rounded-2xl bg-white p-6 text-left shadow-sm">
            <p className="font-serif text-lg text-dark-green">While you wait</p>
            <ul className="mt-3 space-y-2 text-sm leading-relaxed text-muted">
              <li>&bull; Save the dates: 3rd – 28th August 2026.</li>
              <li>&bull; Have a question that can&rsquo;t wait? Call us directly.</li>
              <li>&bull; Follow OaksPlace for programme updates and behind-the-scenes moments.</li>
            </ul>
          </div>
